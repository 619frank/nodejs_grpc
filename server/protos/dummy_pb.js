 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dummy.DummyMessage.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
};
 ...
 * @return {!proto.dummy.DummyMessage} The clone.
 */
proto.dummy.DummyMessage.prototype.cloneMessage = function() {
  return /** @type {!proto.dummy.DummyMessage} */ (jspb.Message.cloneMessage(this));
};
